...
export default <Locale>{
    ...
    packageSearch: {
        ...
        versionTooltip: {
            ...
            hasMinorUpdate: 'Questo pacchetto ha un aggiornamento minore disponibile',
            hasMajorUpdate: 'Questo pacchetto ha un aggiornamento importante disponibile',
            isGit: 'Questo pacchetto è un pacchetto Git',
        },
        noResults: 'Non stai trovando quello che cerchi? <0>Crea una richiesta!</0>',
        search: 'Cerca',
        orphaned: 'Orfano',
        maintainerTooltip: {
