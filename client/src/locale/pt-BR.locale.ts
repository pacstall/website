...
export default <Locale>{
    ...
    packageSearch: {
        ...
        versionTooltip: {
            ...
            hasPatchUpdate: 'Este pacote possui uma atualização de correção disponível',
            hasMinorUpdate: 'Este pacote possui uma atualização menor disponível',
            hasMajorUpdate: 'Este pacote possui uma atualização maior disponível',
