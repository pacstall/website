        ...
        <Modal isCentered isOpen={isOpen} onClose={onClose}>
            ...
            <ModalContent>
                ...
                <ModalBody>
                    ...
                    <Text mt='3'>
                        We don't like to give you misleading or confusing
                        information. We only use cookies for essential features
                        such as theme settings and authentication.
                    </Text>
                    <Text mt='3'>
                    ...
                    <Text mt='3'>
                        ...
                        <strong>
                            give your agreement to the privacy policy.
                        </strong>
                    </Text>
                </ModalBody>
