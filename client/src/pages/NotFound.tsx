...
const ChatBubbleOption0Desktop: FC = () => (
    <>
        ╭───────────────────────────────────────────────────────────╮
        <br />│ Oh, you thought it was <strong>404</strong> but it was me, Pac
        the alpaca! │<br />
        ╰───────────────────────────────────────────────────────────╯
    </>
)
...
const ChatBubbleOption3Desktop: FC = () => (
    <>
        ╭─────────────────────────────────────────────────────────────────────────╮
        <br />
        │ Have you seen my cousin Stall? They were supposed to be on this
        page... │<br />
        ╰─────────────────────────────────────────────────────────────────────────╯
    </>
)
...
const ChatBubble: FC = () => {
    const anyOf = (items: any[]) =>
        items[Math.floor(Math.random() * items.length)]
    const desktopOptions = [
        <ChatBubbleOption0Desktop />,
        <ChatBubbleOption1Desktop />,
        <ChatBubbleOption2Desktop />,
        <ChatBubbleOption3Desktop />,
        <ChatBubbleOption4Desktop />,
    ]
    const mobileOptions = [
        <ChatBubbleOption0Mobile />,
        <ChatBubbleOption1Mobile />,
        <ChatBubbleOption2Mobile />,
        <ChatBubbleOption3Mobile />,
        <ChatBubbleOption4Mobile />,
    ]
