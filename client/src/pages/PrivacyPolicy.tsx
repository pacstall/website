import { Container, Heading, HStack, ListItem, Text, UnorderedList } from "@chakra-ui/react";
...
const PrivacyPolicy: FC = () => (
    <>
        <Navigation />
        <Container mt='10' maxW='900px' textAlign='justify'>
            ...
            <Heading mb='3' mt='7'>Interpretation and Definitions</Heading>
            <Heading size='md' mt='3' mb='2'>Interpretation</Heading>
            ...
            <Heading size='md' mt='3' mb='2'>Definitions</Heading>
            ...
            <Heading mb='3' mt='7'>Collecting and Using Your Personal Data</Heading>
            <Heading size='md' mt='3' mb='2'>Types of Data Collected</Heading>
            <Heading size='sm' mt='2' mb='1'>Personal Data</Heading>
            ...
            <Heading size='sm' mt='2' mb='1'>Usage Data</Heading>
            ...
            <Heading size='md' mt='3' mb='2'>Use of Your Personal Data</Heading>
            ...
            <Heading size='md' mt='3' mb='2'>Retention of Your Personal Data</Heading>
            ...
            <Heading size='md' mt='3' mb='2'>Transfer of Your Personal Data</Heading>
            ...
            <Heading size='md' mt='3' mb='2'>Disclosure of Your Personal Data</Heading>
            <Heading size='sm' mt='2' mb='1'>Business Transactions</Heading>
            ...
            <Heading size='sm' mt='2' mb='1'>Law enforcement</Heading>
            ...
            <Heading size='sm' mt='2' mb='1'>Other legal requirements</Heading>
            ...
            <Heading size='md' mt='3' mb='2'>Security of Your Personal Data</Heading>
            ...
            <Heading mb='3' mt='7'>Children's Privacy</Heading>
            ...
            <Heading mb='3' mt='7'>Links to Other Websites</Heading>
            ...
            <Heading mb='3' mt='7'>Changes to this Privacy Policy</Heading>
            ...
            <Heading mb='3' mt='7'>Contact Us</Heading>
            <Text>If you have any questions about this Privacy Policy, You can contact us:</Text>
            <UnorderedList>
                <ListItem>By email: pacstall@protonmail.com</ListItem>
            </UnorderedList>
        </Container>
    </>
)
