...
const PrivacyPolicy: FC = () => (
    <>
        ...
        <Container my='10' maxW='900px' textAlign='justify'>
            ...
            <Heading textAlign='left' size='md' mt='3' mb='2'>Definitions</Heading>
            ...
            <UnorderedList>
                ...
                <ListItem>
                    <Text><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Pacstall</Text>
                </ListItem>
                <ListItem>
                    <Text><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pacstall.</Text>
                </ListItem>
                <ListItem>
                    <Text><strong>Country</strong> refers to: Washington,  United States</Text>
                </ListItem>
                <ListItem>
            ...
            <Heading textAlign='left' mb='3' mt='7'>Collecting and Using Your Personal Data</Heading>
            <Heading textAlign='left' size='md' mt='3' mb='2'>Types of Data Collected</Heading>
            <Heading textAlign='left' size='sm' mt='2' mb='1'>Personal Data</Heading>
            ...
            <Heading textAlign='left' size='sm' mt='2' mb='1'>Usage Data</Heading>
            ...
            <Heading textAlign='left' size='md' mt='3' mb='2'>Use of Your Personal Data</Heading>
            ...
            <Heading textAlign='left' size='md' mt='3' mb='2'>Retention of Your Personal Data</Heading>
            ...
            <Heading textAlign='left' size='md' mt='3' mb='2'>Transfer of Your Personal Data</Heading>
            ...
            <Heading textAlign='left' size='md' mt='3' mb='2'>Disclosure of Your Personal Data</Heading>
            <Heading textAlign='left' size='sm' mt='2' mb='1'>Business Transactions</Heading>
            ...
            <Heading textAlign='left' size='sm' mt='2' mb='1'>Law enforcement</Heading>
            ...
            <Heading textAlign='left' size='sm' mt='2' mb='1'>Other legal requirements</Heading>
            ...
            <Heading textAlign='left' size='md' mt='3' mb='2'>Security of Your Personal Data</Heading>
            ...
            <Heading textAlign='left' mb='3' mt='7'>Children's Privacy</Heading>
            ...
            <Heading textAlign='left' mb='3' mt='7'>Links to Other Websites</Heading>
            ...
            <Heading textAlign='left' mb='3' mt='7'>Changes to this Privacy Policy</Heading>
            ...
            <Heading textAlign='left' mb='3' mt='7'>Contact Us</Heading>
            <Text>If you have any questions about this Privacy Policy, You can contact us:</Text>
            <UnorderedList>
                <ListItem>By email: <Link href='mailto:pacstall@protonmail.com' color='pink.400'>pacstall@protonmail.com</Link></ListItem>
            </UnorderedList>
        </Container>
    </>
)
